...
let ProblemService = class ProblemService {
    ...
    async postProblemSolution(problemSolution) {
        ...
        const updatedStudent = elo_service_1.updateElos(problemSolution.problem, problemSolution.student, eloResult).then((res) => res);
        const problemSuccess = elo_service_1.isCorrectAnswer(problemSolution.problem, problemSolution.selectedAnswer);
        return new problem_solution_response_1.ProblemSolutionResponse(problemSuccess, await updatedStudent, eloResult);
    }
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7a8785b8b0f9c7b14d9b")
/******/ })();
/******/ 
/******/ }
;