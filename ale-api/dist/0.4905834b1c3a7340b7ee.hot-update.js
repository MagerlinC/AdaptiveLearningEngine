...
const firebaseConfig = {
    apiKey: 'AIzaSyCbznU7USf58YeWwbAuujGxXYDtACEjMPY',
    ...
    messagingSenderId: '1093023838481',
    appId: '1:1093023838481:web:8fb091749e4949daca9cb0',
};
...
/* harmony export */ });
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
...
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(18);
/* harmony import */ var _firebase_logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(19);
...
var Provider = /** @class */ (function () {
            ...
            return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__spreadArray)((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__spreadArray)([], (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__read)(services
                                .filter(function (service) { return 'INTERNAL' in service; }) // legacy services
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                .map(function (service) { return service.INTERNAL.delete(); }))), (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__read)(services
    ...
    Provider.prototype.initialize = function (opts) {
        ...
        try {
            ...
            for (var _c = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__values)(this.instancesDeferred.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
                var _e = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__read)(_d.value, 2), instanceIdentifier = _e[0], instanceDeferred = _e[1];
    ...
    Provider.prototype.invokeOnInitCallbacks = function (instance, identifier) {
        ...
        try {
            for (var callbacks_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__values)(callbacks), callbacks_1_1 = callbacks_1.next(); !callbacks_1_1.done; callbacks_1_1 = callbacks_1.next()) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _firebase_database__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21);
...
/* harmony export */ });
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16);
...
/* harmony import */ var _firebase_logger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(19);
...
var logWrapper = function (prefix) {
    return function () {
        ...
        log.apply(void 0, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__spreadArray)([prefix], (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(varArgs)));
    };
};
var error = function () {
    var varArgs = [];
    ...
    var message = 'FIREBASE INTERNAL ERROR: ' + buildLogMessage_.apply(void 0, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__spreadArray)([], (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(varArgs)));
...
var fatal = function () {
    ...
    var message = "FIREBASE FATAL ERROR: " + buildLogMessage_.apply(void 0, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__spreadArray)([], (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(varArgs)));
    logClient.error(message);
...
var warn = function () {
    ...
    var message = 'FIREBASE WARNING: ' + buildLogMessage_.apply(void 0, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__spreadArray)([], (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(varArgs)));
    ...
    BrowserPollConnection.prototype.open = function (onMessage, onDisconnect) {
        ...
        executeWhenDOMReady(function () {
            ...
            _this.scriptTagHolder = new FirebaseIFrameScriptHolder(function () {
                ...
                var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(args, 5), command = _a[0], arg1 = _a[1], arg2 = _a[2]; _a[3]; _a[4];
                ...
                var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(args, 2), pN = _a[0], data = _a[1];
                _this.incrementIncomingBytes_(args);
...
var TransportManager = /** @class */ (function () {
    ...
    TransportManager.prototype.initTransports_ = function (repoInfo) {
        ...
        if (isSkipPollConnection) {
            ...
            try {
                for (var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__values)(TransportManager.ALL_TRANSPORTS), _c = _b.next(); !_c.done; _c = _b.next()) {
...
var EventEmitter = /** @class */ (function () {
    ...
    EventEmitter.prototype.trigger = function (eventType) {
        ...
        if (Array.isArray(this.listeners_[eventType])) {
            ...
            var listeners = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__spreadArray)([], (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(this.listeners_[eventType]));
...
var OnlineMonitor = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(OnlineMonitor, _super);
...
var VisibilityMonitor = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(VisibilityMonitor, _super);
...
var PersistentConnection = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(PersistentConnection, _super);
    /**
    ...
    PersistentConnection.prototype.restoreState_ = function () {
        ...
        try {
            ...
            for (var _c = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__values)(this.listens.values()), _d = _c.next(); !_d.done; _d = _c.next()) {
                var queries = _d.value;
                try {
                    for (var _e = (e_2 = void 0, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__values)(queries.values())), _f = _e.next(); !_f.done; _f = _e.next()) {
...
var KeyIndex = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(KeyIndex, _super);
    function KeyIndex() {
...
var PriorityIndex = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(PriorityIndex, _super);
...
var IndexMap = /** @class */ (function () {
    ...
    IndexMap.prototype.addIndex = function (indexDefinition, existingChildren) {
        ...
        var newIndexSet = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, this.indexSet_);
        newIndexSet[indexName] = indexDefinition;
        var newIndexes = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, this.indexes_);
...
var MaxNode = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(MaxNode, _super);
    function MaxNode() {
...
var PathIndex = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(PathIndex, _super);
...
var ValueIndex = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(ValueIndex, _super);
    function ValueIndex() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
var ReadonlyRestClient = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(ReadonlyRestClient, _super);
    /**
     * @param repoInfo_ - Data about the namespace we are connecting to
     * @param onDataUpdate_ - A callback for new data from the server
     */
    ...
    ReadonlyRestClient.prototype.restRequest_ = function (pathString, queryStringParameters, callback) {
        ...
        return Promise.all([
            ...
            var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(_a, 2), authToken = _b[0], appCheckToken = _b[1];
...
var StatsListener = /** @class */ (function () {
    ...
    StatsListener.prototype.get = function () {
        ...
        var delta = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, newStats);
        if (this.last_) {
...
function syncPointApplyOperation(syncPoint, operation, writesCache, optCompleteServerCache) {
    ...
    if (queryId !== null) {
        ...
        var events = [];
        try {
            for (var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__values)(syncPoint.views.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var view = _c.value;
...
function syncPointRemoveEventRegistration(syncPoint, query, eventRegistration, cancelError) {
    ...
    if (queryId === 'default') {
        try {
            ...
            for (var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__values)(syncPoint.views.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var _d = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(_c.value, 2), viewQueryId = _d[0], view = _d[1];
...
function repoOnDataUpdate(repo, pathString, data, isMerge, tag) {
    ...
    if (tag) {
        if (isMerge) {
            var taggedChildren = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.map)(data, function (raw) { return nodeFromJSON(raw); });
        ...
        var changedChildren = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.map)(data, function (raw) { return nodeFromJSON(raw); });
...
function decodeQuery(queryString) {
    ...
    try {
        for (var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__values)(queryString.split('&')), _c = _b.next(); !_c.done; _c = _b.next()) {
...
var ReferenceImpl = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(ReferenceImpl, _super);
    /** @hideconstructor */
...
var QueryEndAtConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryEndAtConstraint, _super);
...
var QueryEndBeforeConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryEndBeforeConstraint, _super);
...
var QueryStartAtConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryStartAtConstraint, _super);
...
var QueryStartAfterConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryStartAfterConstraint, _super);
...
var QueryLimitToFirstConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryLimitToFirstConstraint, _super);
...
var QueryLimitToLastConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryLimitToLastConstraint, _super);
...
var QueryOrderByChildConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryOrderByChildConstraint, _super);
...
var QueryOrderByKeyConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryOrderByKeyConstraint, _super);
...
var QueryOrderByPriorityConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryOrderByPriorityConstraint, _super);
...
var QueryOrderByValueConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryOrderByValueConstraint, _super);
...
var QueryEqualToValueConstraint = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(QueryEqualToValueConstraint, _super);
...
function query(query) {
    ...
    try {
        for (var queryConstraints_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__values)(queryConstraints), queryConstraints_1_1 = queryConstraints_1.next(); !queryConstraints_1_1.done; queryConstraints_1_1 = queryConstraints_1.next()) {
...
var Reference = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__extends)(Reference, _super);
    /**
     * Call options:
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("012bf921172740e262e6")
/******/ })();
/******/ 
